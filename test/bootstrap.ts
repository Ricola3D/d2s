...
setConstantData("vanilla", 0x61, vanilla_constants_96 as IConstantData); //alpha? (D2R)
setConstantData("vanilla", 0x62, vanilla_constants_96 as IConstantData); //2.4 (D2R)
setConstantData("vanilla", 0x63, vanilla_constants_99 as IConstantData); //2.5+ (D2R)
setConstantData("remodded", 0x63, remodded_constants_99 as IConstantData); //2.5+ (D2R)
