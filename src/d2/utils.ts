...
export function swapObjectKeyValue<TKeys extends Index, TValues extends Index>(obj: { [key in TKeys]: TValues }) {
  const swappedObj = {} as { [key in TValues]: TKeys };
...
export function b64StringToArrayBuffer(base64string: string): ArrayBuffer {
...
export function hexStringToArrayBuffer(hexStr: string): ArrayBuffer {
...
export function getItemTypeDef(item: IItem, constants: Partial<IConstantData>): any {
...
export function getValueBitSize(itemStatDef: IMagicPropertyDef, valIdx: number) {
  // 0-indexed
...
export function getMaxValue(statId: number, valIdx: number, magical_properties: IMagicPropertyDef[]) {
  // 0-indexed
...
export function getMinValue(statId: number, valIdx: number, magical_properties: IMagicPropertyDef[]) {
...
export function isClass(statId: number, valueIdx: number, magical_properties: IMagicPropertyDef[]) {
...
export function isClassSkillTab(statId: number, valueIdx: number, magical_properties: IMagicPropertyDef[]) {
...
export function isSkill(statId: number, valueIdx: number, magical_properties: IMagicPropertyDef[]) {
  const stat = magical_properties[statId];
...
export function getValueTooltip(statId: number, valueIdx: number, magical_properties: IMagicPropertyDef[]) {
  const stat = magical_properties[statId];
  if (stat.dF == 14) {
...
export function numValues(statId: number, magical_properties: IMagicPropertyDef[]) {
  // 1 - +[value] [string1]
  // 2 - [value]% [string1]
  // 3 - [value] [string1]
  // 4 - +[value]% [string1]
...
export function shift(number: number, shift: number) {
